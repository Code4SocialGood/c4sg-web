...
INSERT INTO `cause`
	VALUES (12,'All'),(13,'Animals'),(14,'Arts & Culture'),(15,'Disaster Relief'),
	(16,'Education'),(17,'Environment'),(18,'International'),(19,'Justice & Legal'),
	(20,'LGBT'),(21,'Politics '),(22,'Poverty'),(23,'Technology'),(24,'Women'),(25,'Youth');
...
INSERT INTO `project`
    VALUES (1,'WebSite Construction','Development of a new website based on one of the available CMS website templates (such as Wordpress, Squarespace, or Drupal. Training to ensure Organization\'s staff members can update content and manage the site post-launch. Note: Only includes websites built on CMS based platforms. This is not a website from scratch.','Project_TeensGive.png',1,NULL,'','','','','Y',NULL,NULL,NULL,'A'),
           ...
           (13,'SEARCH ENGINE MARKETING PLAN','An overall Search Engine Marketing (SEM) plan that includes goals and actionable strategies for improving rankings of Organization’s website or blog.','Project_NASN.jpg',3,NULL,NULL,NULL,'',NULL,'Y',NULL,NULL,NULL,'A','2016-12-25 21:12:08',0,NULL,NULL,NULL,NULL),
